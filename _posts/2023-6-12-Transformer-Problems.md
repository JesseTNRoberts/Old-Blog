...
It seems the case that an additional "tape" would solve this issue. Two tape transformers! With internal and external dialogues! I bet there is good theoretical backing for this. I bet a 2 tape B machine is capable of generating the tape of an arbitrary Turing machine. 
